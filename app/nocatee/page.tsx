...
export default function NocateeTrainingPage() {
  return (
    <div className="page-enter">
      {/* Hero Section */}
      <section className="relative min-h-[70vh] flex items-center justify-center pt-20 clip-slant pb-24 overflow-hidden bg-gradient-to-br from-[#7A8B66]/10 via-[#050505] to-[#050505]" aria-labelledby="nocatee-hero-heading">
        <div className="absolute inset-0 bg-texture opacity-30 pointer-events-none z-0" aria-hidden="true" />
        <div className="max-w-5xl mx-auto px-4 relative z-10 text-center">
          <h1 id="nocatee-hero-heading" className="font-oswald text-5xl md:text-7xl font-bold uppercase tracking-tight leading-[1] mb-6 text-white drop-shadow-2xl">
      ...
      {/* Why Axiom Canine */}
      <section className="py-24 bg-[#0B0C10] border-b border-[#1A2030]" aria-labelledby="nocatee-why-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 id="nocatee-why-heading" className="font-oswald text-4xl font-bold uppercase tracking-widest text-[#7A8B66] mb-12 text-center">Why Axiom Canine for Nocatee?</h2>
          <StaggerContainer>
            <div className="grid md:grid-cols-3 gap-8">
              <AnimatedSection>
                <div className="bg-[#1A2030] p-8 border-l-4 border-[#7A8B66] h-full">
                  ...
                  <p className="text-[#C5C6C7] leading-relaxed">Serving Nocatee for years. We understand the community and your dogs&apos; unique needs.</p>
                </div>
              </AnimatedSection>
              <AnimatedSection>
                <div className="bg-[#1A2030] p-8 border-l-4 border-[#7A8B66] h-full">
                  <h3 className="font-oswald text-2xl uppercase tracking-widest text-white mb-3">In-Home Training</h3>
                  <p className="text-[#C5C6C7] leading-relaxed">We come to your Nocatee home. Train in the environment where your dog spends most time.</p>
                </div>
              </AnimatedSection>
              <AnimatedSection>
                <div className="bg-[#1A2030] p-8 border-l-4 border-[#7A8B66] h-full">
                  <h3 className="font-oswald text-2xl uppercase tracking-widest text-white mb-3">Free Rescue Support</h3>
                  <p className="text-[#C5C6C7] leading-relaxed">Axiom Cares offers free in-home visits for rescue and adopted dogs in Nocatee.</p>
                </div>
              </AnimatedSection>
            </div>
          </StaggerContainer>
      ...
      <section className="py-24 bg-[#050505] border-t border-[#1A2030]" aria-labelledby="nocatee-services-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 id="nocatee-services-heading" className="font-oswald text-4xl font-bold uppercase tracking-widest text-[#7A8B66] mb-12 text-center">Training Services in Nocatee</h2>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <a href="/community" className="bg-[#1A2030] p-8 border border-[#1A2030] hover:border-[#FF5E00] transition-colors group">
              ...
              <p className="text-[#C5C6C7] leading-relaxed mb-4">Free in-home visits for newly adopted dogs in Nocatee. Help with adjustment, basic training, and behavior assessment.</p>
              <span className="text-[#FF5E00] font-semibold">Learn more &rarr;</span>
            </a>
          </div>
        </div>
      ...
      <section className="py-24 bg-[#050505] border-t border-[#1A2030]" aria-labelledby="nocatee-cta-heading">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 id="nocatee-cta-heading" className="font-oswald text-4xl font-bold uppercase tracking-widest mb-4 text-[#7A8B66]">Ready to Transform Your Dog?</h2>
          <p className="text-[#C5C6C7] text-lg mb-10">Schedule your free consultation today. Serving Nocatee and surrounding areas.</p>
