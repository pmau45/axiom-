...
const pageJsonLd = buildSchemaGraph(
  buildLocationServiceSchema('Orange Park, FL', '/orange-park', 'Dog training in Orange Park, FL — behavior modification, obedience, and in-home training for Clay County owners.'),
  buildBreadcrumbList([
    { name: 'Home', path: '/' },
    { name: 'Dog Training in Orange Park, FL', path: '/orange-park' },
  ]),
